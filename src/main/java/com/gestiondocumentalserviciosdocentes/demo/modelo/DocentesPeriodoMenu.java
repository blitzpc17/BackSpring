...
public class DocentesPeriodoMenu {
	...
	public DocentesPeriodoMenu() {
		super();
		// TODO Auto-generated constructor stub
	}

	public DocentesPeriodoMenu(int id_docper, int id_usuarios, int id_periodo, String docper_pdf_horario,
			String docper_pdf_liberacionact, String docper_pdf_reportefinal,
			String docper_retroalimentacion_reportefinal, int docper_estado_reportefinal) {
		super();
	...
	public String toString() {
		return "DocentesPeriodoMenu [id_docper=" + id_docper + ", id_usuarios=" + id_usuarios + ", id_periodo="
				+ id_periodo + ", docper_pdf_horario=" + docper_pdf_horario + ", docper_pdf_liberacionact="
