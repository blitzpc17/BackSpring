...
public class SocialDQ {
	...
	public SocialDQ(int id_documentos_servicio, int id_servicio, String docsev_pdf_Const_extraescolar,
		...
		this.docsev_pdf_Const_extraescolar = docsev_pdf_Const_extraescolar;
		this.docsev_pdf_vigencia_imss = docsev_pdf_vigencia_imss;
		this.docsev_pdf_formato_solicitud = docsev_pdf_formato_solicitud;
		this.docsev_pdf_carta_compromiso = docsev_pdf_carta_compromiso;
		this.docsev_pdf_carta_presentacion = docsev_pdf_carta_presentacion;
		this.docsev_pdf_carta_aceptacion = docsev_pdf_carta_aceptacion;
		this.docsev_pdf_plan_trabajo = docsev_pdf_plan_trabajo;
		this.docsev_pdf_reporte_bimestral = docsev_pdf_reporte_bimestral;
		this.docsev_pdf_bimestral_1 = docsev_pdf_bimestral_1;
		this.docsev_pdf_bimestral_2 = docsev_pdf_bimestral_2;
		this.docsev_pdf_bimestral_3 = docsev_pdf_bimestral_3;
		this.docsev_pdf_reporte_final = docsev_pdf_reporte_final;
		this.docsev_pdf_carta_liberacion = docsev_pdf_carta_liberacion;
		this.docsev_pdf_tarjeta_control = docsev_pdf_tarjeta_control;
		this.docsev_pdf_constancia_liberacion = docsev_pdf_constancia_liberacion;
	}
	...
	public String toString() {
		return "SocialDQ [id_documentos_servicio=" + id_documentos_servicio + ", id_servicio=" + id_servicio
