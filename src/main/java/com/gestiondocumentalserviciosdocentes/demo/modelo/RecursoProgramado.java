...
@Entity
@Table(name = "recurso_programado")
public class RecursoProgramado {
	@Id
	...
	public RecursoProgramado() {
		super();
		// TODO Auto-generated constructor stub
	}
	public RecursoProgramado(int id, int id_periodo, int id_departamento, double cap_dos, double cap_dos_p,
