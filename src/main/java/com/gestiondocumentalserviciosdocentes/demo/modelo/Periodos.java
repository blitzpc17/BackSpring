...
public class Periodos {
	...
	public Periodos(int id_Periodo, byte per_Mes_Inicio, byte per_Mes_Fin, short per_Year, boolean per_Estado,
	...
	public String toString() {
		return "Periodos [id_Periodo=" + id_Periodo + ", per_Mes_Inicio=" + per_Mes_Inicio + ", per_Mes_Fin="
