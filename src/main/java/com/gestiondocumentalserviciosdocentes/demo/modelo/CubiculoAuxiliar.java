...
public class CubiculoAuxiliar {
	...
	public CubiculoAuxiliar() {
		super();
		// TODO Auto-generated constructor stub
	}
	public CubiculoAuxiliar(int id_cubiculo, int id_usuarios, String user_nombre, String cub_nombre, int cub_estado,
	...
	public String toString() {
		return "CubiculoAuxiliar [id_cubiculo=" + id_cubiculo + ", id_usuarios=" + id_usuarios + ", user_nombre="
