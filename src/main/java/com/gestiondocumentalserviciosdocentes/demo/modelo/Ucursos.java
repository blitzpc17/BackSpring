...
public class Ucursos {
	
	private int id_Curso;
	private int id_Departamento;
	private int id_Usuarios;
	private String curso_nombre_usuario;
	...
	public Ucursos(int id_Curso, int id_Departamento, int id_Usuarios, String curso_nombre_usuario, String curso_Nombre,
			String curso_Tipo, int curso_Cupo, int curso_Horas, int curso_Estado, int curso_Visualizacion,
			String curso_pdf_Temario, String curso_creado_por, Date curso_fecha_creacion, String curso_actualizado_por,
			Date curso_fecha_actualizacion) {
		super();
		this.id_Curso = id_Curso;
		this.id_Departamento = id_Departamento;
		this.id_Usuarios = id_Usuarios;
		this.curso_nombre_usuario = curso_nombre_usuario;
	...
	public String getCurso_nombre_usuario() {
		return curso_nombre_usuario;
	}
	public void setCurso_nombre_usuario(String curso_nombre_usuario) {
		this.curso_nombre_usuario = curso_nombre_usuario;
	}
	...
	public String toString() {
		return "Ucursos [id_Curso=" + id_Curso + ", id_Departamento=" + id_Departamento + ", id_Usuarios=" + id_Usuarios
				+ ", curso_nombre_usuario=" + curso_nombre_usuario + ", curso_Nombre=" + curso_Nombre + ", curso_Tipo="
				+ curso_Tipo + ", curso_Cupo=" + curso_Cupo + ", curso_Horas=" + curso_Horas + ", curso_Estado="
				+ curso_Estado + ", curso_Visualizacion=" + curso_Visualizacion + ", curso_pdf_Temario="
				+ curso_pdf_Temario + ", curso_creado_por=" + curso_creado_por + ", curso_fecha_creacion="
				+ curso_fecha_creacion + ", curso_actualizado_por=" + curso_actualizado_por
				+ ", curso_fecha_actualizacion=" + curso_fecha_actualizacion + "]";
	}
