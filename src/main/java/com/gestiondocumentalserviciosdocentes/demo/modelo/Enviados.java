...
public class Enviados {
	...
	public Enviados(int id_Mensajes, int id_Departamento, Date men_fecha_envio, String men_asunto, String men_detalles,
	...
	public String toString() {
		return "Enviados [id_Mensajes=" + id_Mensajes + ", id_Departamento=" + id_Departamento + ", men_fecha_envio="
