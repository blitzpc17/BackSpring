...
public class Innovacion {
	...
	public Innovacion(int id_innovacion, int id_departamento, String inn_etapa, int inn_año, int inn_numero,
	...
	public String toString() {
		return "Innovacion [id_innovacion=" + id_innovacion + ", id_departamento=" + id_departamento + ", inn_etapa="
