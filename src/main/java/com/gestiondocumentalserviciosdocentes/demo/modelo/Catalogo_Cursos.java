...
public class Catalogo_Cursos {
	...
	public Catalogo_Cursos(int id_Curso, int id_Departamento, int id_Usuarios, String curso_Nombre, String curso_Tipo,
	...
	public String toString() {
		return "Catalogo_Cursos [id_Curso=" + id_Curso + ", id_Departamento=" + id_Departamento + ", id_Usuarios="
				...
				+ ", curso_creado_por=" + curso_creado_por + ", curso_fecha_creacion=" + curso_fecha_creacion
				+ ", curso_actualizado_por=" + curso_actualizado_por + ", curso_fecha_actualizacion="
				+ curso_fecha_actualizacion + "]";
	}
