...
public class Infocurso {
	...
	public Infocurso(int id_Instancia, int id_Curso, String inst_Empresa, int inst_Asistentes, String inst_Periodo,
			String inst_Nombre_Curso, String inst_Tipo, int inst_Cupo, int inst_Horas, String inst_Temario,
			String inst_docente_imparte) {
		super();
	...
	public String toString() {
		return "Infocurso [id_Instancia=" + id_Instancia + ", id_Curso=" + id_Curso + ", inst_Empresa=" + inst_Empresa
				+ ", inst_Asistentes=" + inst_Asistentes + ", inst_Periodo=" + inst_Periodo + ", inst_Nombre_Curso="
				+ inst_Nombre_Curso + ", inst_Tipo=" + inst_Tipo + ", inst_Cupo=" + inst_Cupo + ", inst_Horas="
				+ inst_Horas + ", inst_Temario=" + inst_Temario + ", inst_docente_imparte=" + inst_docente_imparte
				+ "]";
	}
