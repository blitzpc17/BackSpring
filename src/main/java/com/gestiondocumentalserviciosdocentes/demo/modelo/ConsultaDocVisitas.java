...
public class ConsultaDocVisitas {
	...
	public ConsultaDocVisitas() {
		super();
		// TODO Auto-generated constructor stub
	}


	public ConsultaDocVisitas(int id_Documentos_Visita, int id_Visita, String docvst_pdf_oficio_solicitud,
	...
	public String toString() {
		return "ConsultaDocVisitas [id_Documentos_Visita=" + id_Documentos_Visita + ", id_Visita=" + id_Visita
