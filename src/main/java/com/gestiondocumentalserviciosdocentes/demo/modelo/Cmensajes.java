...
public class Cmensajes {	
	...
	private String men_nombre_departamento;
	...
	public Cmensajes(int id_Mensajes, int id_Departamento, Date men_fecha_envio, String men_asunto, String men_detalles,
			String men_respuesta, String men_numero_contacto, String men_correo_contacto, String men_informacion,
			int men_estado_visto, int men_estado_envio, int men_tipo_informacion, String men_nombre_departamento,
			int men_remitente, int men_destinatario) {
		super();
		...
		this.men_nombre_departamento = men_nombre_departamento;
	...
	public String getMen_nombre_departamento() {
		return men_nombre_departamento;
	}
	public void setMen_nombre_departamento(String men_nombre_departamento) {
		this.men_nombre_departamento = men_nombre_departamento;
	}
	...
	public String toString() {
		return "Cmensajes [id_Mensajes=" + id_Mensajes + ", id_Departamento=" + id_Departamento + ", men_fecha_envio="
				...
				+ men_tipo_informacion + ", men_nombre_departamento=" + men_nombre_departamento + ", men_remitente="
				+ men_remitente + ", men_destinatario=" + men_destinatario + "]";
	}
