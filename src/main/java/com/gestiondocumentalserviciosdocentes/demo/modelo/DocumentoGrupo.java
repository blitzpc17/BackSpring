...
public class DocumentoGrupo {
	...
	public DocumentoGrupo(int id_documentogrupo, int id_grupo, int id_formato, String docgrp_pdf_documento,
			String docgrp_comentario, int docgrp_estadocomentario) {
		super();
	...
	public String toString() {
		return "DocumentoGrupo [id_documentogrupo=" + id_documentogrupo + ", id_grupo=" + id_grupo + ", id_formato="
				+ id_formato + ", docgrp_pdf_documento=" + docgrp_pdf_documento + ", docgrp_comentario="
				+ docgrp_comentario + ", docgrp_estadocomentario=" + docgrp_estadocomentario + "]";
	}
